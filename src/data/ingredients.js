...
export const MONSTERS = {
  ...
  robot: {
    ...
    character: {
      ...
      // ⚠ 예시의 맛은 order-002 의 첫 대사(disclosed)와 같아야 한다 — 다르면 모델이 예시를
    //   정답으로 흉내 내 옛 답을 말한다 (QA26 에서 orders.js 만 고쳐 실제로 터졌다)
    speech: "반드시 '항목: 값' 나열로만 말한다. 예: \"베이스: 복숭아, 생크림: 레몬, 토핑: 토마토.\" 평서문·감탄사·이모지 금지. 잡담에도 형식 유지(예: \"인사: 확인.\").",
