...
//
//  · dialogue : 손님의 첫 마디 (표면, 애매하게)
//  · persona  : 괴물 성격 (대화 무드/말투). 힌트는 안 새게, 톤만.
//  · hidden.wants : 정답. ★ '적은 항목만' 채점. 안 적은 항목은 상관없음(don't-care).
//  · hints    : 대화로 한 겹씩 흘릴 힌트 사다리
//
//  채점 항목: base(시트조합) / sheetColor / toppings / lettering / cream / deco
//   - base 는 기본 조합(밀가루+우유+계란+버터)이 디폴트. 특수 케이크만 다르게.
// ─────────────────────────────────────────────────────────────
...
export const orders = [
  ...
  },
  {
    ...
    hidden: {
      intent: "말 그대로 케이크 위에 '필요없음'이라는 글자를 써주길 원함. 레터링을 생략하라는 뜻이 아님.",
      wants: { lettering: { text: "필요없음", color: null } },
    },
    hints: [
  ...
  },
  {
    ...
    dialogue: "바닐라 시트에 토마토 토핑 해주세요! 생일초 열 개 넣어주세용",
    hidden: {
      intent: "바닐라 시트 + 토마토 토핑 + 생일초 10개. 명확한 기본 주문.",
      wants: {
        base: BASIC_BASE,
        sheetColor: "vanilla",
        toppings: ["tomato"],
        deco: [{ type: "birthday_candle", count: 10 }],
        lettering: { text: "", color: null },
      },
    },
    hints: ["말한 그대로랍니다! 바닐라, 토마토, 그리고 생일초 열 개!"],
  },
];
