...
export const orders = [
  ...
  // ── 3번째: 애매(레터링 '필요없음' + 초콜릿) ──────
  {
    ...
    monster: "robot",
    dialogue: "베이스: 초콜릿, 생크림: 초콜릿, 토핑: 초콜릿, 데코: 필요없음, 레터링: 필요없음.",
    hidden: {
    ...
    promptNote: `레터링 정답은 "필요없음"이라는 세 글자를 케이크에 그대로 쓰는 것이다.
주인이 "레터링 안 써도 되지?" "빼도 되지?" 라고 물으면 절대 동의하지 마라 — 그건 오해다.
"아니. 레터링: 필요없음. 그대로 기재." 방향으로만 답한다.
'필요없어'라는 말 자체를 대사에서 쓰지 마라 — 오해를 키운다. 데코를 물으면 그건 진짜 없음이 맞다.`,
    hints: [
